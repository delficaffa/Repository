        ...
        private static void MenuVendedores()
        {
            ...
            switch (opcion.ToLower())
            {
                ...
                case "c":
                    ...
                    try
                    {
                        var vendedorParaBuscar = BaseDeDatos.Vendedores
                             .Where(s => s.Dni == dniParaBuscar)
                             .First();
                        MostrarVendedor(vendedorParaBuscar);
                    }
                ...
                case "m":
                    ...
                    try
                    {
                        var vendedorParaEditar = BaseDeDatos.Vendedores
                             .Where(s => s.Dni == dniParaEditar)
                             .First();
                ...
                case "e":
                    ...
                    try
                    {
                        var vendedorParaRemover = BaseDeDatos.Vendedores.Where(s => s.Dni == dniParaRemover)
                            .First();
        ...
        private static void MenuSupervisores()
        {
            ...
            switch (opcion.ToLower())
            {
                ...
                case "c":
                    ...
                    try
                    {
                        var supervisorParaBuscar = BaseDeDatos.Supervisores
                             .Where(s => s.Dni == dniParaBuscar)
                             .First();
                        MostrarSupervisor(supervisorParaBuscar);
                    }   
                    catch (Exception NOEXISTE)
                    {
                ...
                case "a":
                    ...
                    while (cat == "z");
                    var nuevoSupervisorCategoria = cat;
                ...
                case "m":
                    ...
                    try
                    {
                       var supervisorParaEditar = BaseDeDatos.Supervisores
                            .Where(s => s.Dni == dniParaEditar)
                            .First();
                ...
                case "e":
                    ...
                    try
                    {
                        var supervisorParaRemover = BaseDeDatos.Supervisores.Where(s => s.Dni == dniParaRemover)
                            .First();
